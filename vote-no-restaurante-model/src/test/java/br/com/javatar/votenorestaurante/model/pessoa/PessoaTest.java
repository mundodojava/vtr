...
public class PessoaTest {
    ...
    public void deve_respeitar_contrato_equals_hash_code() {
        ...
        EqualsHashCodeAsserts.equalsHashCodeValid(Fixture.from(Pessoa.class).gimme(2, "valid_id_fixo"), Loader.gimme(Pessoa.class, "valid_sem_id"));
    }

    @Test
    public void deve_sobrescrever_to_string() {
        assertThat(Pessoa.class, BeanMatchers.hasValidBeanToStringExcluding("new", "id"));
    }
